...
function get20s(array){
  ...
  for(let i = 0; i < array.length; i++){
    if(parseInt(array[i]['years']) >= 1901){
...
function addArtist(array){
    ...
    array.push({ 
      ...
      genre: 'Web Design', 
      nationality: 'Syrian',
      bio: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis ducimus corporis, magni natus dolore non illo earum saepe doloremque commodi fugiat voluptatem cum quaerat et beatae rem pariatur obcaecati unde. '
    }  );
    return array;
